...
namespace MiningOps.Migrations
{
    ...
    [Migration("20251031095548_MiningMaterial")]
    partial class MiningMaterial
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MiningOps.Entity.MaterialRequest", b =>
                {
                    ...
                    b.Property<int?>("RegisterMiningAccId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RegisterMiningAccId");
            ...
            modelBuilder.Entity("MiningOps.Entity.MaterialRequest", b =>
                {
                    b.HasOne("MiningOps.Entity.RegisterMining", null)
                        .WithMany("MaterialRequests")
                        .HasForeignKey("RegisterMiningAccId");
                });
